...
MACRO(ADD_SWIG_CGAL_PYTHON_MODULE packagename)
  ...
  if(PYTHON3_FOUND)	#AAM
    INCLUDE_DIRECTORIES(${Python3_INCLUDE_DIRS})	#AAM
    ...
    if(${CMAKE_VERSION} VERSION_LESS "3.8.0")
      SWIG_ADD_MODULE(${MODULENAME}_python python ${INTERFACE_FILES} ${source_files})
    else()
    ...
    if (WIN32)
      swig_link_libraries (${MODULENAME}_python ${Python3_LIBRARIES}) #AAM
    elseif (APPLE)
